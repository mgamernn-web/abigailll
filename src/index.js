...
client.on('messageCreate', async (message) => {
  ...
  const GIF_COMMANDS = {
    ...
    '.strangle': { emoji: '🤬', text: 'strangled',      color: 0x8B0000, gifs: [
      'https://media.tenor.com/2nQRYBDT3QQAAAAM/anime-choke-choke.gif',
      'https://media.tenor.com/PiFqVBIspFYAAAAM/anime-choke.gif',
      'https://media.tenor.com/ixaDEFhZJSsAAAAM/anime-choke.gif',
      'https://media.tenor.com/ZiRE7ckQhPEAAAAM/choke-punched.gif',
      'https://media.tenor.com/ZfXseWXWUGoAAAAM/choke-nana-deviluke.gif',
      'https://media.tenor.com/WyKGDhE2h_IAAAAM/mierukochan-choking.gif',
      'https://media.tenor.com/TclCqj4Fj50AAAAM/kubi-shime-anime.gif',
      'https://media.tenor.com/q1dKhDQI_18AAAAM/reze-chainsaw-man.gif',
    ] },
